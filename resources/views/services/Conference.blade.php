      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#services"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#" class="nav-link scrollto active">Event Conferencet</a></li>
  ...
  <main id="main">
    <div class="container service">
      <div class="section-title">
        ...
        <img src="{{asset('img/service/CONFERENCE.jpg')}}" alt="...">
        <p>Provide a full solution in conference management services, from initial planning, online and onsite registrations, programs implementations to post conference reporting.</p>
      </div>
