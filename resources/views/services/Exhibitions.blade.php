        ...
        <ul>
          ...
          <li class="dropdown"><a href="#services"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a class="nav-link scrollto active">Event Exhibitions</a></li>
  ...
  <main id="main">
    <div class="container service">
      <div class="section-title">
        ...
        <img src="{{asset('img/service/EXHIBITIONS.jpg')}}" alt="...">
        <p>We offer a full range package from conceptualization, supporting administration & registration and management services designed to deliver impressive and enjoyable experience for the exhibitors and buyers.</p>
      </div>
