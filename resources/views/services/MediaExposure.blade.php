        ...
        <ul>
          ...
          <li class="dropdown"><a href="#services"><span>Services</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="#" class="nav-link scrollto active">Media Exposure</a></li>
              <li><a href="{{route('EventManagement') }}">Event Entertainment</a></li>
              <li><a href="{{route('MediaExposure') }}">Event Management</a></li>
            </ul>
          </li>
    ...
    <div class="container service">
      <div class="section-title">
        <div class="title-concept">
          <h2>Event Exposure</h2>
        </div>
        <img src="{{asset('img/service/Media-exposure.png')}}" alt="...">
